...
{
	idc = 1105543;
	text = "<a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #01</a>  NO Racism.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #02</a> NO Impersonating an Admin.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #03</a> NO Intentional Team Killing.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #04</a> NO Griefing/Harassment.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #05</a> NO Firing at Base.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #06</a> NO Wasting server Assets.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #07</a> NO Using Voice in Restricted Channels.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #08</a> NO Using Vehicles as Taxi’s in Base.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #09</a> NO Playing as Infantry while in Pilot Slot.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #10</a> NO Arguing over punishment in game with an admin.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #11</a>  NO Pilots, UAV operator, or ATC role without being on TeamSpeak.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #12</a> NO Players under 16 years old.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #13</a> NO Verbal abuse. (Cursing at other players).<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #14</a> NO Indecent, homophobic, obscene, lewd, or sexually explicit language.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #15</a> NO Recruiting.<br/><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>RULE #16</a> NO <a href='https://www.naksquad.net/mods'>unapproved mods.</a><br/><br/><t align='center'><a color='#f1d970' href='https://www.naksquad.net/nak-server-rules/'>COMPLETE SERVER RULES</a></t><br/><br/><t align='center'><a color='#f1d970' href='https://www.naksquad.net/mods/'>MODS (ALLOWED AND RESTRICTED)</a></t>";
	x = 0.335938 * safezoneW + safezoneX;
	y = 0.318 * safezoneH + safezoneY;
...
{
	idc = 554778;
	text = "<t color='#FFD700' size='2' shadow='2' shadowColor='#000000' align='center'>WELCOME TO NAK SQUAD</t><br/>";
	x = 0.335938 * safezoneW + safezoneX;
...
{
	idc = 554222;
	text = "<a color='#FFD700' href='https://naksquad.net/register/'>REGISTER</a>";
	x = 0.250625 * safezoneW + safezoneX;
	y = 0.794 * safezoneH + safezoneY;
	w = 0.0853125 * safezoneW;
	h = 0.028 * safezoneH;
	tooltip = "Click To Join Our Family";
};
class RscBRutton_1601: RscStructuredText
{
	idc = 554444;
	text = "<a color='#FFD700' href='https://naksquad.net/teamspeaktrans/'>TEAMSPEAK</a>";
...
{
	idc = 44455222;
	text = "<a color='#FFD700' href='https://naksquad.net/feedtransf/'>FEEDBACK</a>";
...
{
	idc = 55544223;
	text = "<a color='#FFD700' href='https://naksquad.net/donate/'>DONATE</a>";
