...
switch (_TheGodPhase2) do {
      ...
      //_pilotGunnervt2 = missionNamespace getVariable "pilotGunnervt2"; _pilotGunnervt2 set [(_prayGod -1), _pylons]; missionNamespace setVariable ["pilotGunnervt2", _pilotGunnervt2];
