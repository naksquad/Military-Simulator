...
_censors = ["B_Heli_Transport_03_unarmed_F","B_Heli_Transport_01_F","B_CTRG_Heli_Transport_01_tropic_F","I_Heli_light_03_unarmed_F","O_Heli_Light_02_unarmed_F","B_Heli_Light_01_dynamicLoadout_F","B_Heli_Light_01_F","B_Plane_Fighter_01_Stealth_F","B_Plane_Fighter_01_F",
"B_T_VTOL_01_armed_F","O_T_VTOL_02_infantry_dynamicLoadout_F","I_Heli_light_03_dynamicLoadout_F","O_Heli_Light_02_dynamicLoadout_F","I_Heli_Transport_02_F","B_CTRG_Heli_Transport_01_tropic_F","B_T_VTOL_01_infantry_F","O_Plane_CAS_02_dynamicLoadout_F","B_Plane_CAS_01_dynamicLoadout_F","O_Plane_Fighter_02_F"];
...
_tarup1 = ["Land_Pod_Heli_Transport_04_covered_F","Land_Pod_Heli_Transport_04_bench_F","O_Heli_Transport_04_ammo_F","O_Heli_Transport_04_box_F","O_Heli_Transport_04_fuel_F","O_Heli_Transport_04_medevac_F","O_Heli_Transport_04_covered_F"];
...
_skinexcep = ["B_Truck_01_mover_F","B_APC_Tracked_01_CRV_F"];
...
if (_t in _ceasrbt) then {
	_u addMagazineCargoGlobal ["2000Rnd_65x39_Belt_Tracer_Red",[-1]];
	_u addMagazineCargoGlobal ["2000Rnd_65x39_Belt_Tracer_Red",[-1]];
	_u addWeaponCargoGlobal ["LMG_Minigun_Transport",[-1]];
	_u addMagazineCargoGlobal ["120Rnd_CMFlare_Chaff_Magazine",[0]];
	_u addMagazineCargoGlobal ["120Rnd_CMFlare_Chaff_Magazine",[-1]];
	_u addWeaponCargoGlobal ["CMFlareLauncher",[0]];
	_u addWeaponCargoGlobal ["CMFlareLauncher",[-1]];
};
...
if (_t in _PYjeth12) then {
	switch (_lemonde) do {
    case "Altis": { 
					[_u, ["<t color='#47842c'>Mobile Asenal</t>", "VA.sqf"]] remoteExec ["addAction", -2, true];
    ...
    case "Tanoa": { 	[_u, ["<t color='#47842c'>Mobile Asenal</t>", "VA.sqf"]] remoteExec ["addAction", -2, true];
					if !(isNil "paapicoo") then { deleteVehicle paapicoo;};
...
{	
	[( _this select 0),{_this addAction ["<t color='#af1611'>Dynamic loadout</t>", "createDialog 'mondieujetensuplin'",[1],0,false,true,"", "driver _target == _this"]} ] remoteExec ["call", -2, true];
};

if(_t in _PYjeth4) then 
{	
	[( _this select 0),{_this addAction ["<t color='#af1611'>Dynamic loadout</t>", "createDialog 'mondieujetensuplin007'",[1],0,false,true,"", "driver _target == _this"]} ] remoteExec ["call", -2, true];
};
