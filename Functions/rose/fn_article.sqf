...
[
	[
		...
		["box",["Media\images\Tac.jpg","You won't believe how playing NAK Tac Ops can change your life!"]],
		...
		["draft","Server rules:"],
		["text","RULE #1) NO Racism. RULE #2) NO Impersonating an admin. RULE #3) NO Intentional Team Killing. RULE #4) NO Griefing/Harassment. RULE #5) NO Firing at base."],
		["text","RULE #6) NO Wasting Server Assets. RULE #7) NO Using voice in restricted channels. RULE #8) NO Playing as infantry while a pilot. RULE #9) NO Arguing over punishment in game."],
		["text","RULE #10) NO Using vehicles as taxi’s at Base. RULE #11) NO Pilots, UAV operator, or ATC role without being on TeamSpeak. RULE #12) NO Players under 16 years old."],
		["text","RULE #13) NO Verbal abuse. (Cursing at players) RULE #14) NO Excessive use of indecent, obscene, lewd, or sexually explicit language. RULE#15) NO Recruiting"],


		["author",["Media\Billboards\vileace.jpg","VileAce is a NAK Tac journalist"]]
	]
