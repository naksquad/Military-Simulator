...
_QS_ST_groupIconScale = 0.5;										// NUMBER. Group Icon Scale. Default = 0.75
_QS_ST_groupIconOffset = [0.001,0.001];							// ARRAY (NUMBERS). [X,Y], offset position of icon from group leaders position. Can be positive or negative numbers. Default = [0.65,0.65];
