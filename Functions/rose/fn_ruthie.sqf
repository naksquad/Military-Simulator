...
switch (_lemonde) do {
    case "Altis": { 
                        ...
                        to_lelasts =
                        {
                                ...
                                ["USS Freedom HQ",format["%1:%2",_txthour, _txtmin], str(levent), str(groupId (group player))] spawn BIS_fnc_infoText;
                        };
                        ...
                        _missionsData   = [
								...
								[getmarkerpos "elite",to_elite,"Rewards HQ","Teleport to  the Reward HQ","","\a3\ui_f\data\gui\cfg\hints\vehiclecommanding_ca.paa",1,[]],
								[getmarkerpos "vehiculesss",to_vehiculesss,"Vehicles HQ","Teleport to the Vehicles HQ","","\a3\ui_f\data\gui\cfg\hints\firing_ca.paa",1,[]],
								[getmarkerpos "pilot",to_pilot,"Rotor-wing HQ","Teleport to the Rotor-Wing HQ","","Media\images\heli.paa",1,[]],
								[getmarkerpos "boat",to_boat,"S Boat HQ","Teleport to the S Boat HQ","","\a3\ui_f\data\gui\cfg\hints\sdv_ca.paa",1,[]],
								[getmarkerpos "WeaponTestRange",to_WeaponTestRange,"Weapon Test Range HQ","Teleport to the Weapon Test Range HQ","","\a3\ui_f\data\gui\cfg\hints\weapondeployment_ca.paa",1,[]],
								[getmarkerpos "boat_1",to_boat_1,"N Boat HQ","Teleport to the N Boat HQ","","\a3\ui_f\data\gui\cfg\hints\sdv_ca.paa",1,[]],
								[getmarkerpos "atc5",to_lelasts,"USS Freedom HQ","Teleport to the USS Freedom HQ","","\a3\ui_f_jets\data\gui\cfg\hints\aircrafttakeoffcarrier_ca.paa",1,[]],
								[getmarkerpos "jet",to_jet,"Fixed-Wing HQ","Teleport to the Fixed-Wing HQ","","\a3\ui_f_jets\data\gui\cfg\hints\aircrafthud_ca.paa",1,[]],
								[getmarkerpos "MILITARY_BASE_1",to_radar,"Anti-aircraft HQ","Teleport to the Anti-aircraft HQ","","\a3\ui_f_jets\data\gui\cfg\hints\sensorstypes_ca.paa",1,[]],
								[getmarkerpos "boat_2",to_boat_Fournos,"Fournos Boats HQ","Teleport to the Fournos Boats HQ","","\a3\ui_f\data\gui\cfg\hints\sdv_ca.paa",1,[]],
								[getmarkerpos "boat_4",to_boat_Atsalis,"Atsalis Boats HQ","Teleport to the Atsalis Boats HQ","","\a3\ui_f\data\gui\cfg\hints\sdv_ca.paa",1,[]],
								[getmarkerpos "uavstr",to_uavstr,"UAV HQ","Teleport to the UAV HQ","","\a3\ui_f\data\gui\cfg\hints\uavtypes_ca.paa",1,[]],
								[getmarkerpos "boat_3",to_boat_CAPE,"Cape Boats HQ","Teleport to the Cape Boats HQ","","\a3\ui_f\data\gui\cfg\hints\sdv_ca.paa",1,[]],
    ...
    case "Malden": {
                        ...
                        _missionsData   = [
                                        [getmarkerpos "BASE",to_base,"Main HQ","Teleport to the Main HQ","","Media\images\nakcommand.paa",1,[]],
                                        [getmarkerpos "elite",to_elite,"Jet HQ","Teleport to the Jet HQ","","Media\images\fixedwing.paa",1,[]],
                                        [getmarkerpos "vehiclehq",to_vehiculesss,"Vehicles HQ","Teleport to the Vehicles HQ","","Media\images\vehiculehq.paa",1,[]],
                                        [getmarkerpos "boat",to_boat,"S Boat HQ","Teleport to the S Boat HQ","","Media\images\boathq.paa",1,[]],
                                        [getmarkerpos "boat_1",to_boat_1,"N Boat HQ","Teleport to the N Boat HQ","","Media\images\boathq.paa",1,[]],
                                        [getmarkerpos "antiairbas",to_uavttp,"Anti-aircraft HQ","Teleport to the Anti-aircraft HQ","","Media\images\naksquad1.paa",1,[]],
                                        [getmarkerpos "uss992",to_lelasts,"USS Freedom HQ","Teleport to the USS Freedom HQ","","Media\images\lecan.paa",1,[]]
                        ];
    ...
    case "Tanoa": { 
                        ...
                        _missionsData   = [
                                        ...
                                        [getmarkerpos "elite",to_elite,"AOFL HQ","Teleport to  the AOFL HQ","","Media\images\rewardhq.paa",1,[]],
                                        [getmarkerpos "aVEMARIAL",to_lelasts,"USS Freedom HQ","Teleport to the USS Freedom HQ","","Media\images\lecan.paa",1,[]],
                                        [getmarkerpos "respawn_west_pilots",to_jet,"Fixed-Wing HQ","Teleport to the Fixed-Wing HQ","","Media\images\fixedwing.paa",1,[]],
                                        [getmarkerpos "heavuveh",to_jets,"Combat Vehicles HQ","Teleport to the Combat Vehicles HQ","","Media\images\vehiculehq.paa",1,[]]
                        ];
