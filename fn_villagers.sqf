 ...
 sleep 2;
        ...
        while {true} do {
            ...
            if ( _villeaceDBblock == 1 ) exitWith { hint "Database loaded, Welcome to NAK";};
            _countert = _countert + 5;
             if ((_countert >= 60) && (_villeaceDBblock == 0)) exitWith { hint "Database Error Please Join Again";"end2" call BIS_fnc_endMission;};
            sleep 5;
        };
